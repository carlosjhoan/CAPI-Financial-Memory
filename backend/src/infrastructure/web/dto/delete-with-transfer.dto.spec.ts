...
import { DeleteWithTransferDto, DistributionItemDto, DistributionItemWithGoalDto } from './delete-with-transfer.dto';

const VALID_UUID = '123e4567-e89b-42d3-a456-426614174000'; // v4 UUID (version nibble = 4)

function makeDistItem(targetPocketId: string, amount: number): DistributionItemDto {
...
describe('DeleteWithTransferDto', () => {
  ...
  describe('DeleteWithTransferDto', () => {
    ...
    it('should validate distributions sum with custom validator', async () => {
      ...
      const distSizeError = errors.find(e =>
