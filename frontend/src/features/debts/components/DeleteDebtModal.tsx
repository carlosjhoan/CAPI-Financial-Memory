...
export interface DeleteDebtModalProps {
  isOpen: boolean;
  onClose: () => void;
  debt: Debt | null;
...
const DeleteDebtModal: React.FC<DeleteDebtModalProps> = ({
  ...
  return (
    <Modal
      ...
      description="¿Estás seguro de que deseas eliminar esta deuda?"
      size="md"
    >
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-red-700 dark:text-red-300">
                <p>
                  La deuda será eliminada permanentemente del sistema, incluyendo todos los pagos registrados.
                </p>
              </div>
            </div>
          </div>
