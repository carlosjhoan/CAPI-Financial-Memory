...
const DeleteLoanModal: React.FC<DeleteLoanModalProps> = ({
  ...
  return (
    <Modal
      ...
      description="¿Estás seguro de eliminar este préstamo?"
      size="md"
    >
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-red-700 dark:text-red-300">
                <p>
                  Solo se pueden eliminar préstamos completamente pagados.
                  El préstamo será eliminado permanentemente del sistema.
                </p>
              </div>
            </div>
          </div>
